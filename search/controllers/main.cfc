component {
	...
	function index(any rc) {
        ...
        if( isNull(rc.notice) ){    
            rc.notice = {type="notice",message="Choose one or more criteria.  When you are finished, click the 'Search' button.  <br><br><strong>This database contains comprehensive SLN data for 2000 onwards.  Historical data will be added on an ongoing basis.</strong>"};
        }
