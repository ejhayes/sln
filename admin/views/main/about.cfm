...
<p>This application is designed to allow users to search for active and inactive SLN registrations issued by DPR.  Users can enter search criteria (for example, crop/site, U.S. EPA registration number, chemical) to generate a list of matching special local need registrations with their associated labels.</p>
