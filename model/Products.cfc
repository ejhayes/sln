...
component schema="LABEL" table="PRODUCT" readonly="true"
{
    ...
    property name="RestrictedStatus" fieldtype="many-to-many" cfc="RestrictedStatuses" linktable="PROD_SPECIAL_STATUS" fkcolumn="PRODNO" inversejoincolumn="SPECSTAT_CD" readonly="true" orderby="SPECSTAT_DSC";
